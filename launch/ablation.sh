...
CUDA_VISIBLE_DEVICES=5 nohup uv run expts/ablation_omn.py > launch/logs/ablation_omn.log 2>&1 &
CUDA_VISIBLE_DEVICES=6 nohup uv run expts/ablation_qwem.py > launch/logs/ablation_qwem.log 2>&1 &
